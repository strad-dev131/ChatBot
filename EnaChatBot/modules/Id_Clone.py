...
from EnaChatBot import EnaChatBot as app, save_clonebot_owner, save_idclonebot_owner
from EnaChatBot import EnaChatBot, db as mongodb
...
@app.on_message(filters.command(["idclone", "cloneid"]) & filters.user(int(OWNER_ID)))
